...
CREATE INDEX public_discount_discount_start_index ON public.discount (DATE(discount_start AT TIME ZONE 'localtime'));
COMMENT ON INDEX public_discount_discount_start_index IS 'Для поиска по выражению, приводящему timestamp with time zone к дате';
